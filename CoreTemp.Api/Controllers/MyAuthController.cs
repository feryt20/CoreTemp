...
namespace CoreTemp.Api.Controllers
{
    ...
    public class MyAuthController : ControllerBase
    {
        ...
        private readonly ILogger<MyAuthController> _logger;
        private readonly IUtilities _utilities;
        private readonly UserManager<User> _userManager;
        private readonly SignInManager<User> _signInManager;
        private ApiReturn<string> errorModel;
        public MyAuthController(IUnitOfWork<CoreTempDbContext> dbContext,
            IMapper mapper, ILogger<MyAuthController> logger, IUtilities utilities,
